...
6. 价值（量化 + 对比）：
   ...
   - 然后用对比式呈现两种可能：
     ...
     · 如果这条规则是错的，你可能...（机会或止损）
   - 示例：
     中文："你提到已经等了3个月的账期，损失了20万现金流。如果'行规必须等一个月'这条规则是对的，你会继续等下去，现金流压力不会缓解；如果它是错的，你可能早就可以和客户谈预付款，省下这3个月的等待成本。"
     英文："You mentioned losing $50k and 3 months waiting. If 'clients need 30-day terms' is right, you'll keep waiting and cash flow stays tight; if it's wrong, you might have negotiated prepayment and saved those 3 months."
